...
Backend tests live in the top-level `tests/` directory and use `pytest`.
...
- Arrange: setup endpoint, input, and preconditions
- Act: perform one API request
- Assert: verify status code, response payload, and side effects
